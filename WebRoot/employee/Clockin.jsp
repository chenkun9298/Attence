...
<form class="layui-form" action="Clockin.do" id="form" style="position:absolute; left: 550px;top:50px;"  >
 ...
 <div class="layui-form-item">
    <label class="layui-form-label">打卡时间</label>
     <div class="layui-input-inline">
      <input type="text" name="ClockinTime"  id="ClockinTime" readonly="readonly" class="layui-input">
    </div>
  </div>
...
/**
    ...
    */
    ...
    document.getElementById('ClockinTime').value= getCurrentDate(2);
